...
/* OSX */
 [_OSX] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, RSFT_T(KC_ENT), \
 ...
 [_LOWER] = LAYOUT(
        ...
        G(____), G(KC_Z), G(KC_X), G(KC_C), G(KC_V), G(KC_B), _______,          _______, _______, _______, _______, _______, _______, _______, \
                          _______, _______, XXXXXXX, _______,G(KC_SPC),         _______, _______, _______, _______, _______  \
 ),
...
/* MEDIA */
 ...
 [_ADJUST] = LAYOUT(
        _______, LK_QWRT, LK_OSX,  LK_GAME, _______, _______,                            KC_SCT1, KC_SCT2, KC_SCT3, KC_SCT4, KC_SCT5, _______, \
        _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______, \
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [3] =   { ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(KC_PGUP, KC_PGDN)  },
